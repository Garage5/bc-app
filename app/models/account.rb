class Account < ActiveRecord::Base
  ...
  validates_exclusion_of :subdomain, :in => %W( app support blog www billing help api #{AppConfig['admin_subdomain']} ), :message => "The domain <strong>{{value}}</strong> is not available."
